defmodule Director.TodoTasksKafkaContext do
  ...
  def create_kafka_message({from_t1, until_t2}, pair) do
    # Maak task
    todo_task = %AssignmentMessages.TodoTask{task_operation: :ADD, currency_pair: pair, from_unix_ts: from_t1 |> DateTime.to_unix, until_unix_ts: until_t2 |> DateTime.to_unix, task_uuid: Ecto.UUID.generate}
    # Encode task
